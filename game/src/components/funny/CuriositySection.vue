...
<template>
  <div v-if="fact" class="p-5 animate-in fade-in zoom-in duration-500">
    ...
    <div class="shadow rounded-xl p-4">
        ...
        <button @click="fetchFacts"  class=" rounded-2xl text-s bg-lyellow hover:dyellow font-black text-text py-2 px-3 hover:-translate-y-1 hover:scale-105 duration-300">
          Another 
        </button>
    </div>
  </div>
