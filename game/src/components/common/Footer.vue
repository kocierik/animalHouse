  ...
  <footer class="p-2 bg-lgreen color_footer shadow md:px-6 md:py-8">
    <div class="sm:flex sm:items-center sm:justify-around p-10">
      <a class="flex justify-center mb-4 sm:mb-0">
        ...
        <img alt="animal House logo" src="/logoTransparent.png" width="128" height="128" />
      </a>
      <ul class="flex flex-wrap items-center justify-center mb-6 text-sm text-black-500 sm:mb-0 dark:text-black-900">
        <li class="flex mr-4 p-2 rounded md:mr-6 hover:-translate-y-1 duration-300 hover:bg-green-300">
          <a href="#">About</a>
        </li>
        <li class="flex mr-4 p-2 rounded md:mr-6 hover:-translate-y-1 duration-300 hover:bg-green-300">
        ...
        <li class="flex no-underline p-2 rounded hover:-translate-y-1 duration-300 hover:bg-green-300">
    ...
    <span class="block text-sm text-black-500 sm:text-center dark:text-black-400 text-center">
      <div class="flex justify-center p-5">
        <div class="w-8 text-text hover:-translate-y-3 duration-300">
          <a href="facebook.com" class="hover:text-gray-700">
        ...
        <div class="w-8 ml-2 text-text hover:-translate-y-3 duration-300">
          <a href="twitter.com" class="hover:text-gray-700">
        ...
        <div class="w-8 ml-2 text-text hover:-translate-y-3 duration-300">
          <a href="github.com" class="hover:text-gray-700">
      ...
      © 2022 <a href="#" class="hover:underline">AnimalHouse</a>. All Rights Reserved.
    </span>
  </footer>
</template>
