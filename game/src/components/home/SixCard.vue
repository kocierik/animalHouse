    ...
    <div class="container xl:max-w-6xl mx-auto px-4">
      ...
      <header class="text-center mx-auto mb-12 lg:px-20">
        ...
        <p class="text-gray-500 leading-relaxed font-light text-xl mx-auto pb-2">
          Explore all the opportunities offered by Animal House
        </p>
      </header>
      <!-- End heading -->
      <!-- row -->
      <div class="flex flex-wrap flex-row -mx-4 text-center">
        ...
        >
          ...
          >
            ...
            <h3 class="text-lg leading-normal mb-2 font-semibold text-black">Search for help</h3>
            <p class="text-gray-500">
              Animal House personal can help you with every need. Checkout our 
            services!</p>
          </div>
          <!-- end service block -->
        </div>
        ...
        >
          ...
          >
            ...
            <p class="text-gray-500">Animal House has a huge community by
              humans and animals. Become part of it!</p>
          </div>
          <!-- end service block -->
        </div>
        <div
        ...
        >
          ...
          >
            ...
            <h3 class="text-lg leading-normal mb-2 font-semibold text-black">Fun</h3>
            <p class="text-gray-500">Have fun with our wide selection of online games and learn
              about your friend with our fun section.</p>
          </div>
          <!-- end service block -->
        </div>
        <div
