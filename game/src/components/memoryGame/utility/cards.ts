...
export const defaultCard: Card = { firstName: ' ', id: 0, view: 'visible', bg: '', selected: false, opacity: 1 };

const cards = ref<Card[]>([
  { firstName: 'Frank', id: 1, view: 'visible', bg: 'blue', selected: false, opacity: 1 },
  { firstName: 'Frank', id: 2, view: 'visible', bg: 'blue', selected: false, opacity: 1 },
  { firstName: 'Vic', id: 3, view: 'visible', bg: 'blue', selected: false, opacity: 1 },
  { firstName: 'Vic', id: 4, view: 'visible', bg: 'blue', selected: false, opacity: 1 },
  { firstName: 'Gina', id: 5, view: 'visible', bg: 'blue', selected: false, opacity: 1 },
  { firstName: 'Gina', id: 6, view: 'visible', bg: 'blue', selected: false, opacity: 1 },
