...
$("#productPostSend").click(function () {
      ...
      fetch("/v1/products", {
            ...
            .then((data) => {
                  console.log(data);
                  $("#productPostResult").html(
                        "<h3>Here is the product you added</h3>"
                  );
                  $("#productPostResult").append(
                        [
                              {
                                    displaySize: "-md-12",
                                    img: data.image,
...
function retrieveProduct(target, id) {
      //leave id blank to retrieve all products
