...
<tr>
    <td class="p-2 py-8 border-b border-solid border-gray-300">
        <div class="pl-4 flex flex-wrap flex-row items-center">
            ...
            <div class="mr-4 h-16 w-64 block flex flex-row items-center text-gray-700">${username}</div>
            <div class="mr-4 h-16 w-64 block flex flex-row items-center text-gray-700">${firstName}</div>
            <div class="mr-4 h-16 w-64 block flex flex-row items-center text-gray-700">${lastName}</div>
        </div>
