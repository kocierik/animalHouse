            ...
            <div className="flex items-center">
              ...
              <div className="hidden md:block">
                <div className="ml-10 flex items-baseline space-x-4">
                  ...
                  <span
                    style={{ backgroundColor: history.pathname === '/forum/trending' ? 'indigo' : '' }}
                    className="hover:-translate-y-1 hover:scale-105 duration-300 text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium"
                  >
                    <Link to="/forum/trending">Forum</Link>
        ...
        {nav && (
          <div data-aos="zoom-in" className="md:hidden" id="mobile-menu">
            <div data-aos="zoom-in" className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              ...
              >
                <a
                  className=" text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium cursor-pointer block px-4 py-2 text-sm text-gray-700"
                  onClick={() => {
                    navigate('/')
                    setNav(!nav)
                  }}
