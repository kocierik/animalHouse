  ...
  return (
    <>
      <div data-aos="zoom-in" className="px-3 md:lg:xl:px-40  rounded border-t border-b py-20 bg-opacity-10">
          ...
          {services?.map((service, i) => {
            return (
              <div
                ...
                key={i}
                className="hover:-translate-y-2 hover:scale-100 duration-300"
              >
                <div
                  data-aos="zoom-in"
        ...
        <div
          data-aos="zoom-in"
          className="w-full flex flex-col rounded bg-indigo-900 shadow-xl shadow-indigo-200 py-10 px-20 flex justify-between items-center"
        >
          ...
          <button
            ...
            className="px-5 py-3 hover:-translate-y-2 hover:scale-100 duration-300 font-medium text-white shadow-xl  hover:bg-indigo-900 duration-150  bg-indigo-800"
          >
            BOOK AN APPOINTMENT{' '}
          </button>
        </div>
