     ...
     <div className="h-full" data-aos="fade-up" data-aos-duration="500">
      <div className="container mx-auto px-4 sm:px-8">
        <div className="py-8">
          ...
          <div>
            <img className="rounded-xl mb-10" src="https://static.lav.it/image/full/34920b7962b4c32d31e9d8199ae0aed0/page-blocks-extra/adozioni-dirette.png?v=4"/>
            <img className="rounded-xl" src="https://static.lav.it/image/medium/f5460ba9285577fd9fa8b8c159802903/page-blocks-extra/adozione-distanza-3.jpg"/>
          </div>
        </div>
        <div>
