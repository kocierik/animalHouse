...
const cards = [
  ...
  svg:  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
...

{
  ...
  svg:  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-orange-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
...

{
  name: "Dog Sitter",
  description: "Last used 1 days ago",
  svg:  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-red-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
...

{
  ...
  svg:  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-indigo-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
          <path strokeLinecap="round" strokeLinejoin="round" d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z" />
        </svg>,
...
const FeatureCard = () => {
  ...
  <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
    { cards.map((card,i) => {
      return(
    <div key={i} className="flex hover:-translate-y-3 hover:scale-105 duration-300  items-start rounded-xl bg-white p-4 shadow-lg">
      <div className={card.color}>
          {card.svg}
      </div>  
      <div className="ml-4 cursor-pointer" onClick={() => {setShowModal(true); setOpenService(card.name) }}>
